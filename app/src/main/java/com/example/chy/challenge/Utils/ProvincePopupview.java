...
import com.example.chy.challenge.Findpersoanl.mine.PostJobActivity;
 ...
 */
public class ProvincePopupview implements PopupWindow.OnDismissListener, View.OnClickListener, OnWheelChangedListener {

    private static final int GETEDUCATION = 1;
    private PostJobActivity mactivity;
    ...
    public ProvincePopupview(PostJobActivity mActivity) {
        ...
        tv_job_location = (TextView) rootView.findViewById(R.id.tv_job_city);//tv工作地点
